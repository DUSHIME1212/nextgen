...
export default function TestimonialsSection() {
  ...
  return (
    <section className=" bg-muted overflow-hidden py-20">
      <div className="space-y-4">
        <div className="/10 inline-block rounded-full  px-4 py-1.5 text-sm font-medium text-blue-500">
          Client Testimonials
            </div>
        <div className="mx-auto mb-12 animate-fade-in">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            What our People says about us
          </h2>
          <p className="text-muted-foreground w-2/3">
            We take pride in our work and the relationships we build with our clients. Here’s what some of them have to say about their experience with us.
          </p>
        </div>
        
        <div className="relative mx-auto">
          <div className="relative mx-auto w-[500px] h-[400px] md:h-[300px]">
